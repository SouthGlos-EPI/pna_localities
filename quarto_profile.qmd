...
**Specialist Medicines Provider**: `r number_text(loc_pharm_smp)` `r pluralise_noun(loc_pharm_smp, "pharmacy")`. 

**Influenza vaccination**: `r number_text(loc_pharm_flu)` `r pluralise_noun(loc_pharm_flu, "pharmacy")` providing this advanced service. 

**Stoma appliance customisation**: `r number_text(loc_pharm_stoma)` `r pluralise_noun(loc_pharm_stoma, "pharmacy")` providing this service. 

**Appliance Use Reviews**: `r number_text(loc_pharm_aur)` `r pluralise_noun(loc_pharm_aur, "pharmacy")` providing this service. Many appliances will be dispensed by DACs based around the country, which may provide this service.
