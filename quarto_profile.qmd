...
number_text <- function(x, cap = TRUE) {
  if (x == 0) {
    ...
    if (cap == T) str_to_title(as.english(x)) else as.english(x)
  } else {
    x
  }
}
...
* `r number_text(loc_pharm_7days)` `r pluralise_noun(loc_pharm_7days, "pharmacy")` open 7 days a week
* `r number_text(loc_pharm_6days)` `r pluralise_noun(loc_pharm_6days, "pharmacy")` open 6 days a week
* `r number_text(loc_pharm_5days)` `r pluralise_noun(loc_pharm_5days, "pharmacy")` open 5 days a week
* `r number_text(loc_pharm_open_before8)` `r pluralise_noun(loc_pharm_open_before8, "pharmacy")` open before 8:00 at least 5 days a week
* `r number_text(loc_pharm_open_past630)` `r pluralise_noun(loc_pharm_open_past630, "pharmacy")` open past 18:30 at least 5 days a week
